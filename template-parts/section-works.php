...
<section id="works" class="my-works portfolio-content">
    <div class="work-preview hide-tablet">
        <?php
    ...
    <div class="work-lists hide-tablet">
    ...
    <div class="mobile-work-carousel">
        <div class="owl-carousel owl-theme">
            <?php 
                for($project = 0; $project < count($projectArray); $project++): 
                    $previewID = $projectArray[$project];
                    $title = get_the_title( $previewID );
                    $categories = get_the_category( $previewID );
                    $tags = get_the_tags( $previewID );
                    $catCount = count($categories);
