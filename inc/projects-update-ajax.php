...
function rei_update_work_preview(){
    $previewID = $_POST['workid'];
...
add_action("wp_ajax_nopriv_rei_update_work_preview", "rei_update_work_preview");
add_action("wp_ajax_rei_update_work_preview", "rei_update_work_preview");


/* Work Exp Details */
function rei_update_exp_details_preview(){
    $previewID = $_POST['workid'];
    $title = get_the_title($previewID);
    $content = get_post_field('post_content', $previewID);
?>
<h4>Work Details For:</h4>
<h2><?php echo $title; ?></h2>
<div class="work-detail"><?php echo $content; ?></div>
<?php
  exit;
}

add_action("wp_ajax_nopriv_rei_update_exp_details_preview", "rei_update_exp_details_preview");
add_action("wp_ajax_rei_update_exp_details_preview", "rei_update_exp_details_preview");